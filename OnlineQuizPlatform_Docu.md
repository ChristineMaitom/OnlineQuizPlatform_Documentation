...
Project Features:
• Quiz Creation Tool: Allows users to create quizzes with various question types, including multiple choice, true/false, short answer, and multimedia-enhanced questions.
